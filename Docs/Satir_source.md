...
> 自動產生於 **2026-08-01 22:00**，由 `discover_sources.py` 讀 `/home/runner/work/SatirDaily/SatirDaily/Docs/Satir_website.md` 產出。
...
| `satir_org` | 台灣薩提爾成長模式推展協會 | — | ⬜ 待勘查 | 🔴 連線失敗 (ConnectionError) | [列表頁](https://www.satir.org.tw/) |
...
- **連線檢查**：🟢 可連線 (HTTP 200)　（檢查時間 2026-08-01 21:59）
...
- **連線檢查**：🔴 連線失敗 (ConnectionError)　（檢查時間 2026-08-01 21:59）
...
- **連線檢查**：🟢 可連線 (HTTP 200)　（檢查時間 2026-08-01 22:00）
- **Content-Type**：`text/html`
