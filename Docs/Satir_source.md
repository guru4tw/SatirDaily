...
> 自動產生於 **2026-07-28 22:09**，由 `discover_sources.py` 讀 `/home/runner/work/SatirDaily/SatirDaily/Docs/Satir_website.md` 產出。
...
- **連線檢查**：🟢 可連線 (HTTP 200)　（檢查時間 2026-07-28 22:08）
...
- **連線檢查**：🔴 連線失敗 (HTTP 415)　（檢查時間 2026-07-28 22:08）
- **Content-Type**：`text/html`
